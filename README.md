# ~~Pretty~~ Minimal But Featureful PowerShell

> Function over form. - Taujhon
...
```powershell
irm "https://github.com/jjazzer/powershell-profile/raw/main/setup.ps1" | iex
```
...
- Installs Oh My Posh, zoxide, Terminal-Icons, and the JetBrainsMono Nerd Font.
...
You can also place `custom.PowerShell_profile.ps1` beside `Microsoft.PowerShell_profile.ps1`. It is loaded before this profile reads override variables and functions.
